...
const CustomerReviewsPage: FC = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            <h1 className="text-center font-sans text-4xl text-[#10AC98] mb-5">Opinie kupujących</h1>
            ...
            <div className="flex justify-start items-center gap-2 mb-3 w-100 md:w-3/4 lg:w-2/3">
                ...
                <Select value={sortType} onChange={handleSort} size="small">
                    <MenuItem value={'desc'}>
                        <div className={'pr-10'}>Pozytywne</div>
                    </MenuItem>
                    <MenuItem value={'asc'}>
                        <div className={'pr-10'}>Negatywne</div>
                    </MenuItem>
                    <MenuItem value={'none'}>
                        <div className={'pr-10'}>Wyczyść filtr</div>
                    </MenuItem>
                </Select>
            </div>
