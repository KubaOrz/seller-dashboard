...
const OfferRankingPage: FC = () => {
    ...
    return (
        <div className="flex flex-col gap-4 items-center">
            <h1 className="text-center font-sans text-4xl text-[#10AC98] mb-5">Ranking ofert</h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 w-100 gap-4 md:w-4/5 lg:w-5/6">
                {offers.map((offer, index) => (
                    <RankingOffer key={index} imgSrc={MockRankingImage} productName={offer.productName} soldNumber={offer.soldNumber} rotation={offer.rotation}  />
                ))}
            </div>
