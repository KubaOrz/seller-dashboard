...
const RankingOffer: FC<RankingOfferData> = props => {
    ...
    return (
        <div className={'rounded-xl shadow-xl transition-all hover:scale-105 cursor-pointer w-52 dark:bg-secondary-dark'}>
            <div>
                <img src={props.imgSrc} alt={'image'} className={'object-fill'} />
            </div>
            <div className={'p-2'}>
                <div className={'flex flex-col'}>
                    <p className={'text-center text-headerText-light dark:text-headerText-dark font-sans'}>{t(props.productName)}</p>
                    <Divider />
