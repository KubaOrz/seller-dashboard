...
import { SellerQualityAspect, SellerQualityData } from '../../../tools/mock-data/seller-quality/sellerQuality';
                ...
                <div className={'flex gap-2 justify-between'}>
                    {
                        worstAspects.map((aspect, index) => (
                            <SingleSellerQuality key={index} name={aspect.name} imgSrc={getQualityAspectImage(aspect.name)} assesment={aspect.assesment} />
                        ))
                    }
                </div>
                <Divider sx={{ mt: 1, mb: 2 }} />
